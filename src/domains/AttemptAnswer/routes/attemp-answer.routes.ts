...
import { AttemptAnswerController } from "../controller/attemp-answer.Controller";
...
} from "../validator/attempt-answer.validator"
...
export class AttemptAnswerRoutes {
  ...
  constructor(
    private readonly controller: AttemptAnswerController,
  ) {
    this.router = Router();
